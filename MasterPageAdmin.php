    ...
    function menuLeft(){
        $xau = '
            ...
            <div class="list-group list-group-flush">
                <a href="BrandAdmin.php" class="list-group-item list-group-item-action bg-light">
                    <i class="fa fa-table"></i>
                    <span>Brands</span>
                </a>
                <a href="ProductAdmin.php" class="list-group-item list-group-item-action bg-light">
                    <i class="fa fa-table"></i>
                    <span>Product</span>
                </a>
            </div>
