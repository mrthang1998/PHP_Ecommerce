                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="bootstrap-table">
                                    ...
                                    <a href="Products/create.php" class="btn btn-primary"><?php echo $_SESSION['adminname']; ?></a>
                                                ...
                                                if ($result = $con->query($sql)) {
                                                    if ($result->num_rows > 0) {
                                                        while ($row = $result->fetch_array()) {
                                                            ...
                                                            echo " <td><a href='Products/Update.php?id=" . $row['id'] . "' class='btn btn-primary'><i class='fa fa-pencil' aria-hidden='true'></i> Sửa</a>
