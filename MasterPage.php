                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-9 col-sm-12 email text-wrapper">
                            <a href="#">
                                <p>Email: worldmobile2020@gmail.com</p>
                            </a>
                        </div> <!-- .email -->
                        <div class="col-md-3 col-sm-12 sdt text-wrapper">
                            <a href="#">
                                <p>Hotline: 0398283366</p>
                            </a>
                        ...
                        <div class="col-md-4">
                            <div class="footer-widget">
                                ...
                                <div class="footer-widget-content">
                                    <a href="#">
                                        Email: thang.daovanbao@students.hueic.edu.vn
                                    </a>
                                    <p>Địa chỉ: 80B Nguyễn Lộ Trạch, Huế</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="footer-widget">
                                ...
                                <div class="footer-hosting">
                                    <a href="https://tgs.com.vn/vi/">Hosting: <www class="thanghosting"></www>.com.vn</a>
