<?php
        ...
        if(empty($nameErr)&&empty($emailErr)&&empty($passwordErr)&&empty($cpasswordErr)){
            ...
            $phone = $_POST['phone'];
            $queryCreate = "insert into user (username, pass, email, phone) VALUES ('$name', '$password1', '$email', '$phone');";
                    ...
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" id="password" placeholder="BanHang@123" class="form-control">
                                <span class="error"><?php echo $passwordErr;  ?></span>
                            </div>
                            <div class="form-group">
                                <label for="password" class="text-info">Confirm Password:</label><br>
                                <input type="password" name="cpassword" id="cpassword"  placeholder="BanHang@123" class="form-control">
