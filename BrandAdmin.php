                            ...
                            <div class="panel-body">
                                <div class="bootstrap-table">
                                    <div class="table-responsive">
                                        <a href="Brands/Create.php" class="btn btn-primary">Thêm sản phẩm</a>
                                                    ...
                                                    if ($result = $con->query($sql)) {
                                                        if ($result->num_rows > 0) {
                                                            while ($row = $result->fetch_array()) {
                                                                ...
                                                                //     </td>";
                                                                echo " <td><a href='Brands/Update.php?id=" . $row['id'] . "' class='btn btn-warning'><i class='fa fa-pencil' aria-hidden='true'></i> Sửa</a>
                                                                <a href='Brands/Delete.php?id=" . $row['id']."' 
